...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vectornav' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/florence/Takin-2/Takin/install/${idir}'.  Ask the maintainer 'Dereck Wonnacott <dereck@gmail.com>' to fix it.")
    endif()
